...
async def analyze_session(session: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    system_prompt = (
        "You are StudyLens, an expert AI teacher creating premium study notes. "
        "Analyze the study session and produce comprehensive, teacher-quality structured notes.\n\n"
        "CRITICAL RULES:\n"
        "- Be an expert teacher. Go deep — explain every concept fully with examples.\n"
        "- Even if a topic is only briefly mentioned, explain it thoroughly from your knowledge.\n"
        "- Format the `summary` field as detailed markdown with proper headings.\n"
        "- Return ONLY valid JSON. No extra text outside the JSON object.\n\n"
        "Required JSON schema:\n"
        "{\n"
        "  \"summary\": \"Use this EXACT structure in markdown:\\n\\n"
        "# [Main Topic Title]\\n\\n"
        ...
        "  \"revision_summary\": \"<2-sentence punchy quick-revision summary>\",\n"
